                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax Amount<span>Tk. {{ number_format($tax)  }}</span></li>
                                        <li>Shipping<span>Tk. {{$shipping = 100}}</span></li>
                                        @php($grandTotal = $total + $tax + $shipping)
                                        <li class="last">Total Payable<span>Tk. {{ number_format($grandTotal) }}</span></li>
                                    </ul>
                                    <div class="button">
                                        <a href="{{route('checkout')}}" class="btn">Checkout</a>
                                        <a href="{{route('fishbang-home')}}" class="btn btn-alt">Continue shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>
