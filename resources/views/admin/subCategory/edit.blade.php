        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Edit SubCategory Page</h4>
                            ...
                            <form action="{{route('subCategory.update',['id' => $subCategory->id])}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4" >
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description" class="form-control" id="">{{$subCategory->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4" >
                                    ...
                                    <div class="col-sm-9">
                                        <button type="submit" class="btn btn-success form-control w-50" id="">UPDATE SUB-CATEGORY</button>
                                    </div>
                                </div>
                            </form>
                        </div>
